  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <Image src="/segment.png" width="800" height="301" />

        <h2>Turn-around points</h2>

        <h3>Pond Square</h3>
        <Image src="/pond-square.png" width="800" height="408" />
        ...
        <p>The <a href="https://www.strava.com/segments/30194326">Clawathon</a> consists of 4 full reps and a complete rep of Fitzroy. <strong>It does not matter what distance your GPS reads</strong> - without a full Fitzroy it is not a Clawathon.</p>
